const prefix = "https://global-services-corporation.github.io/images/academy";

const coachingMentoriaCover = `${prefix}/coaching-mentoria.jpg`;
const corporateGovernanceCover = `${prefix}/corporate-governance.jpg`;
const financaCorporativaCover = `${prefix}/financa-corporativa.jpg`;
const gestaoMarketingCover = `${prefix}/gestao-de-marketing.jpg`;
const gestaoPessoasCover = `${prefix}/gestao-de-pessoas.jpg`;
const gestaoEstategicaCover = `${prefix}/gestao-estrategica.jpg`;
const higieneSegurancaCover = `${prefix}/higiene-seguranca.jpg `;
const inteligenciaEmocionalCover = `${prefix}/inteligencia-emocional-empatia.jpg`;
const liderancaExecutivaCover = `${prefix}/lideranca-executiva.jpg`;
const liderandoEquipesCover = `${prefix}/liderando-equipes-hibridas.jpg`;
const transformacaoDigitalCover = `${prefix}/transformacao-digital.jpg`;

export const productsInfo = [
  {
    id: 1,
    coverImg: gestaoEstategicaCover,
  ...
  {
    id: 2,
    coverImg: financaCorporativaCover,
  ...
  {
    id: 3,
    coverImg: liderancaExecutivaCover,
  ...
  {
    id: 4,
    coverImg: inteligenciaEmocionalCover,
  ...
  {
    id: 5,
    coverImg: coachingMentoriaCover,
  ...
  {
    id: 6,
    coverImg: higieneSegurancaCover,
  ...
  {
    id: 8,
    coverImg: corporateGovernanceCover,
  ...
  {
    id: 9,
    coverImg: liderandoEquipesCover,
  ...
  {
    id: 11,
    coverImg: transformacaoDigitalCover,
